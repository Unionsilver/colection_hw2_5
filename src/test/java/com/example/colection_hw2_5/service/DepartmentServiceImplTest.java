...
class DepartmentServiceImplTest {
    ...
    Employee Alex1 = new Employee(" Alex1 ", " Alexandrov1 ", 1, 20000);
    Employee Alex2 = new Employee(" Alex2 ", " Alexandrov2 ", 1, 30000);
    Employee Alex3 = new Employee(" Alex3 ", " Alexandrov3 ", 3, 40000);
    ...
    void findMaxSalaryEm_employeeNotFind_trowEmployeeNotFoundException() {
        ...
        int department = 1;
        EmployeeNotFoundException ex = assertThrows(EmployeeNotFoundException.class, () -> underTest.findMaxSalaryEm(1));
    ...
    void findMinSalaryEm_employeeNotFind_trowEmployeeNotFoundException() {
        when(employeeService.printAllEmployee()).thenReturn(Collections.emptyList());
        int department = 1;
        EmployeeNotFoundException ex = assertThrows(EmployeeNotFoundException.class, () -> underTest.findMinSalaryEm(1));
        assertEquals("нет сотрудников в отделе" + department, ex.getMessage());
    }
